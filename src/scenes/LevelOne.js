...
class LevelOne extends Phaser.Scene {
    ...
    create() {
        ...
        this.mision1 = this.add.image(420, 360, 'm1_n1').setInteractive();
        this.mision1.setScale(1.55);
        this.mision2 = this.add.image(850, 360, 'm2_n1').setInteractive();
        this.mision2.setScale(1.55);

        //Agregamos la activación de las cartas
        this.mision1.on('pointerdown', function (){
            this.scene.start('InicioM1_N1');  
        }, this);

        this.mision2.on('pointerdown', function (){
            this.scene.start('InicioM2_N1');
        }, this);
